...
from ..parametres import definir_parametres_groq, masquer, obtenir_cle_groq, obtenir_modele_groq
...
def modifier(parametres: ParametresGroq, _actuel: dict = Depends(utilisateur_courant)) -> dict:
    definir_parametres_groq(parametres.groq_api_key, parametres.groq_model)
    return {"statut": "ok"}
